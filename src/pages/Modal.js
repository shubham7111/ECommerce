...
<div className="modal">
<div className="cancel-btn" onClick={closeModal}> x</div>
<form>
                    <p><strong>Name: </strong><input type = "text" name = "name" onChange={setInputHandler}/></p>

                    
                    <p><strong>Address: </strong><input type = "text" name = "area" onChange={setInputHandler}/></p>

                    <p><strong>Phone: </strong><input type = "text" name = "phone" onChange={setInputHandler}/></p>
